...
class MealTableViewController: UITableViewController {
    ...
    */
    ...
    private func loadSampleMeals() {
        let photo1 = UIImage(named: "scrambledEggs")
        let photo2 = UIImage(named: "feijoada")
        let photo3 = UIImage(named: "spaghetti")
        
        guard let meal1 = Meal(name: "Scrambled Eggs", photo: photo1, rating: 4) else {
            fatalError("Unable to instantiate meal1")
        }
        
        guard let meal2 = Meal(name: "Feijoada", photo: photo2, rating: 5) else {
